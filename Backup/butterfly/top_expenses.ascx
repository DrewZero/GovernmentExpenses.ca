<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="top_expenses.ascx.cs" Inherits="Metamorph.top_expenses" %>
	...
	<asp:Repeater ID="ctlTopExpenses" runat="server">
		...
		<ItemTemplate>
			<tr>
				<td>
					<a href="/show_top_expense.aspx?id=<%# Container.ItemIndex %>&member_name=<%# HttpUtility.UrlEncode(DataBinder.Eval(Container.DataItem, "member_name").ToString()) %>&<%# m_query %>">
