<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="lowest_expenses.ascx.cs" Inherits="Metamorph.lowest_expenses" %>
	...
	<asp:Repeater ID="ctlLowestExpenses" runat="server">
		...
		<ItemTemplate>
			<tr>
				<td>
					<a href="/show_lowest_expense.aspx?id=<%# Container.ItemIndex %>&member_name=<%# HttpUtility.UrlEncode(DataBinder.Eval(Container.DataItem, "member_name").ToString()) %>&<%# m_query %>">
